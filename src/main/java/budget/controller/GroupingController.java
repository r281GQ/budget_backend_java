...
public class GroupingController {
    ...
    @PreAuthorize("#grouping.user.identifier == principal.user.identifier")
    ...
    @PreAuthorize("#grouping.user.identifier == principal.user.identifier && @securityHelper.isRealResource(#grouping)")
